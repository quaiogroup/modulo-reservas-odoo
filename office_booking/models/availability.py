...
class OfficeAvailability(models.TransientModel):
    _name = "office.availability"
    _description = "Disponibilidad oficinas (vista)"
    _rec_name = "office_id"

    office_id = fields.Many2one("office.space", required=True, string="Oficina")
    ...
    d0_m_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    d0_a_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    ...
    d1_m_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    d1_a_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    ...
    d2_m_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    d2_a_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    ...
    d3_m_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    d3_a_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    ...
    d4_m_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    d4_a_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    ...
    d5_m_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    d5_a_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    ...
    d6_m_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)
    d6_a_booking_id = fields.Many2one("office.booking", compute="_compute_week", store=False)

    @api.depends("office_id", "week_start")
    def _compute_week(self):
        Booking = self.env["office.booking"].sudo()
        for rec in self:
