...
class OfficeSubscription(models.Model):
    ...
    def _notify_admin(self, template_xml_id):
        ...
        admin_email = (
            param.get_param("office_booking.admin_email")
    ...
    def action_mark_paid(self, tx_id=None):
        ...
        for rec in self:
            ...
            rec._notify_customer("office_booking.mail_template_plan_confirmed_user")
            rec._notify_admin("office_booking.mail_template_plan_confirmed_admin")
