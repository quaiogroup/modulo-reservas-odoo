...
class SpootOfficeSettings(models.TransientModel):
    _name = "spoot.office.settings"
    _description = "Configuración de Spoot Office Booking"
    ...
    def default_get(self, fields_list):
        ...
        res["admin_email"] = param.get_param(
            "spoot_office_booking.admin_email", ""
        )
        return res
    ...
    def action_edit_tpl_booking_pending(self):
        return self._open_template("spoot_office_booking.mail_template_booking_pending_payment")

    def action_edit_tpl_booking_confirmed_plan(self):
        return self._open_template("spoot_office_booking.mail_template_booking_confirmed_plan")

    def action_edit_tpl_booking_confirmed_bold(self):
        return self._open_template("spoot_office_booking.mail_template_booking_confirmed_bold")

    def action_edit_tpl_booking_reminder(self):
        return self._open_template("spoot_office_booking.mail_template_booking_reminder")

    def action_edit_tpl_booking_cancelled_user(self):
        return self._open_template("spoot_office_booking.mail_template_booking_cancelled_user")

    def action_edit_tpl_booking_cancelled_admin(self):
        return self._open_template("spoot_office_booking.mail_template_booking_cancelled_admin")

    def action_edit_tpl_booking_new_admin(self):
        return self._open_template("spoot_office_booking.mail_template_booking_new_admin")
